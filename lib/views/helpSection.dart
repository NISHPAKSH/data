                   ...
                   // width: 265,
                    child: Column(
                     ...
                     margin: EdgeInsets.fromLTRB(0, 0, 50, 0),
                        ...
                        Components.helpRow(width:screenWidth,height:screenHeight,text:AppStrings.purpose,onTap:() {assetsAudioPlayer.open(
                            Playlist(
                                audios: [
                        ...
                        Components.helpRow(width:screenWidth,height:screenHeight,text:AppStrings.whois,onTap:() {assetsAudioPlayer.open(
                          Audio("assets/sounds/H2.mp3"),);} ),
                        Components.helpRow(width:screenWidth,height:screenHeight,text:AppStrings.interactive,onTap:() {assetsAudioPlayer.open(
                          Audio("assets/sounds/H3.mp3"),);} ),
                        Components.helpRow(width:screenWidth,height:screenHeight,text:AppStrings.recommended,onTap:() {assetsAudioPlayer.open(
                          Audio("assets/sounds/H4.mp3"),);} ),
                        Components.helpRow(width:screenWidth,height:screenHeight,text:AppStrings.settings,onTap:() {assetsAudioPlayer.open(
                          Audio("assets/sounds/H5.mp3"),);} ),
                        Components.helpRow(width:screenWidth,height:screenHeight,text:AppStrings.monitored,onTap:() {assetsAudioPlayer.open(
                          Audio("assets/sounds/H6.mp3"),);} ),
                        Components.helpRow(width:screenWidth,height:screenHeight,text:AppStrings.appwork,onTap:() {assetsAudioPlayer.open(
                          Audio("assets/sounds/H7.mp3"),);} ),
                        Components.helpRow(width:screenWidth,height:screenHeight,text:AppStrings.privacy,onTap:() {assetsAudioPlayer.open(
