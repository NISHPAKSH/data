      ...
      child: Scaffold(
        body: Container(
          ...
          child: Column(
            ...
            children: [
              Expanded(
                  child: Components.startContent( width:screenWidth,height:screenHeight,   text1: AppStrings.vitaCore,text2: AppStrings.tactics,text3:AppStrings.strategies,onTap:  () => {Get.to(TacticsQuestion())}, )
              ),
