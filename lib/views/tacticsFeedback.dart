          ...
          children: [
            Expanded(
              ...
              Components.feedbackContent(
                width: screenWidth,
                height: screenHeight,
                toptext: AppStrings.prestrategies,middletext: AppStrings.topstrategies,text1: AppStrings.seeking,text2: AppStrings.honestyconflicts,
        text3: AppStrings.adapts,text4: AppStrings.situations,text5:AppStrings.problems,),
