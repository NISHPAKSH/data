        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              Expanded(
                child:
                Components.startContent(width:screenWidth,height:screenHeight,
                  text1: AppStrings.vitaCore,text2: AppStrings.lifePriorities,text3:AppStrings.asyougrow,onTap:  () => {Get.to(PriorityQuestion())}, )
